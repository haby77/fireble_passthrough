...
#define CONFIG_PWM1_DEFAULT_IRQHANDLER                  TRUE       /*!< Enable/Disable PWM0 Interrupt */
#define CONFIG_PWM1_ENABLE_INTERRUPT                    TRUE       /*!< Enable/Disable PWM1 Default IRQ Handler */
